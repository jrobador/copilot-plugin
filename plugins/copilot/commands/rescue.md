...
argument-hint: "[--background|--wait] [--resume|--fresh] [--model <model>] [--effort <low|medium|high|xhigh|max>] [--unsafe-shell] [--allow-wide-root] [what Copilot should investigate, solve, or continue]"
context: fork
