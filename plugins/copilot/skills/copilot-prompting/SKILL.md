...
description: Internal guidance for composing Copilot prompts for coding, review, diagnosis, and research tasks across GPT-5.4, GPT-5.3-Codex, and Gemini 3.1 Pro inside the Copilot Claude Code plugin
...
Concrete end-to-end templates live in [references/copilot-prompt-recipes.md](references/copilot-prompt-recipes.md).
Common failure modes to avoid live in [references/copilot-prompt-antipatterns.md](references/copilot-prompt-antipatterns.md).
